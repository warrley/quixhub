...
export const IRA_DISTRIBUTIONS: Record<string, { mean: number | null; std: number | null; students?: number }> = {
  'Engenharia de Software': { mean: 7.75713015, std: 1.67180061, students: 400 },
  'Ciência da Computação': { mean: 7.06818247, std: 1.6854862 },
  'Sistemas de Informação': { mean: 7.22044086, std: 1.78380585 },
  'Engenharia da Computação': { mean: 6.2446, std: 2.0459 },
  'Redes de Computadores': { mean: 6.31597328, std: 2.03052092 },
  'Design Digital': { mean: 8.37783527, std: 1.23697138 },
